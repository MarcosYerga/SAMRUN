...
class Attack1(HeroState):
    def __init__(self):
        super().__init__()
        self.next_state = ""
        self.__load_assets()
        self.__hero, _ =AssetsManager.instance().get("ATTACK1")
        self.__columns = cfg_item("entities","hero","attack1_col")
    ...
    def __load_assets(self):
        AssetsManager.instance().load(AssetType.Image, 'main', "ATTACK1", cfg_item("entities", "hero","attack1"))